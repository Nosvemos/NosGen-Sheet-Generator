...
const translations = {
  en: {
    ...
    "hint.workflowTitle": "Workflow hint",
    "hint.workflowStep1": "1. Import PNG frames.",
    "hint.workflowStep2": "2. Add points and rename them.",
    "hint.workflowStep3": "3. Adjust atlas settings and export.",
    "tab.frame": "Frame",
    "tab.atlas": "Atlas",
